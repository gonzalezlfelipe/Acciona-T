...
import 'colegio_record.dart';
import 'usuarios_record.dart';
import 'comunicaciones_record.dart';
import 'reporte_record.dart';
import 'tienda_escolar_record.dart';
import 'cursos_record.dart';
import 'eventos_record.dart';
import 'encuestas_record.dart';
import 'actividades_curso_record.dart';
import 'articulos_perdidos_record.dart';
import 'convenios_record.dart';
...
@SerializersFor(const [
  ColegioRecord,
  UsuariosRecord,
  ComunicacionesRecord,
  ReporteRecord,
  TiendaEscolarRecord,
  CursosRecord,
  EventosRecord,
  EncuestasRecord,
  ActividadesCursoRecord,
  ArticulosPerdidosRecord,
  ConveniosRecord,
])
