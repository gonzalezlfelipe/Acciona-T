...
class CentroPadresyAlumnosWidget extends StatefulWidget {
  const CentroPadresyAlumnosWidget({
    Key key,
    this.tipoCentro,
  }) : super(key: key);
  ...
  @override
  _CentroPadresyAlumnosWidgetState createState() =>
      _CentroPadresyAlumnosWidgetState();
}

class _CentroPadresyAlumnosWidgetState
    extends State<CentroPadresyAlumnosWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CentroPadresyAlumnos'});
  }
