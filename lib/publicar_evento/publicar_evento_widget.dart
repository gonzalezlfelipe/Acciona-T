...
class PublicarEventoWidget extends StatefulWidget {
  const PublicarEventoWidget({Key key}) : super(key: key);

  @override
  _PublicarEventoWidgetState createState() => _PublicarEventoWidgetState();
}

class _PublicarEventoWidgetState extends State<PublicarEventoWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Publicar_evento'});
                      ...
                      onPressed: () async {
                        ...
                        if (uploadedFileUrl == null) {
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Cargar foto referencial'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                                        Navigator.pop(alertDialogContext),
                        ...
                        final eventosCreateData = createEventosRecordData(
                          tituloEvento: textController1.text,
